#[test_only]
module lending_core::logic_flash_repay_tests {
    use 0x2::tx_context;
    use 0x2::object;
    use 0x1::type_name;
    use 0x2::clock;
    ...
    fun test_cumulate_to_supply_index_div_by_zero_when_no_supply() {
        // Build storage with zero total supply for reserve 0
        ...
        st.reserves_count = 1;
        // calling cumulate_to_supply_index with positive accrual will divide by zero in current implementation
        logic::cumulate_to_supply_index(&mut st, 0, 1);
    }
}
