    ...
    fun calc_pool_update_rewards(arg0: &Incentive, arg1: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg2: u64, arg3: u8, arg4: address) : (vector<u256>, vector<u256>) {
        ...
        while (v1 < 0x1::vector::length<0x1::ascii::String>(&v0.coin_types)) {
            ...
            if (v5 < v7) {
                ...
                let v12 = 0;
                if (v10 > 0) {
                    let v13 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::safe_math::mul(*0x1::vector::borrow<u256>(&v0.rates, v1), (v7 - v5) as u256);
                    v12 = v13 / v10;
                };
                v9 = v8 + v12;
            };
            ...
            if (arg4 != @0x0) {
                ...
                let (v18, _) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_user_balance(arg1, arg3, arg4);
                v14 = v14 + (v9 - v16) * v18;
            };
